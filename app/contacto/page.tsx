    ...
    <>
      ...
      <Section className="bg-white">
        <div className="grid gap-4 md:grid-cols-3">
          {[
            { t: "Para clínicas", d: "Reserva una demo personalizada con nuestro equipo comercial.", href: "/clinicas" },
            { t: "Para profesionales", d: "Resuelve dudas sobre verificación, tarifas o calendario.", href: "/profesionales" },
