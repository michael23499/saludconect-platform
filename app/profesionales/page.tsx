...
const BENEFITS = [
  ...
  { t: "Conéctate con clínicas privadas", d: "Acceso directo a clínicas verificadas en toda España." },
  { t: "Más oportunidades, más flexibilidad", d: "Diversifica tu actividad sin renunciar a tu actividad principal." },
  { t: "Tu talento merece mejor", d: "Tarifas transparentes acordadas directamente con la clínica. Sin comisiones." },
  { t: "Lleva tu carrera al siguiente nivel", d: "Construye red profesional y reputación con cada colaboración." },
  { t: "Gratis. Siempre.", d: "Los profesionales nunca pagamos suscripción. SaludCoNet es 100% gratis para ti." },
];
        ...
        <div className="relative mx-auto grid w-full max-w-7xl gap-10 px-5 py-20 md:grid-cols-[1.1fr_1fr] md:px-8 md:py-28">
          <div>
            ...
            <p className="mt-5 max-w-xl text-pretty text-mist-500 md:text-lg">
              Encuentra jornadas, turnos y colaboraciones en clínicas privadas. Tú decides cuándo, dónde y con quién. Gestiona tu disponibilidad desde una sola plataforma.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Button href="/registro?rol=profesional" size="lg">Crear perfil gratuito</Button>
              <Button href="/como-funciona" variant="secondary" size="lg">Ver cómo funciona</Button>
            </div>
