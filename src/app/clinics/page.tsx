...
const FEATURES = [
  ...
  { icon: "◍", t: "Geolocalizador por sede", d: "Encuentra profesionales cercanos a cada sede" },
  { icon: "◫", t: "Acuerdo directo", d: "Cierras la contratación directamente con el profesional" },
];
        ...
        <div className="relative mx-auto grid w-full max-w-7xl gap-10 px-5 py-20 md:grid-cols-[1.2fr_1fr] md:px-8 md:py-28">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button href="/register?rol=clinic" size="lg">Empezar prueba 14 días</Button>
              <Button href="/search" variant="outline" size="lg">Explorar talento</Button>
            </div>
