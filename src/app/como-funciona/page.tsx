...
const METRICS = [
  ...
  {
    v: "0 €",
    l: "Comisión por reserva",
    icon: (
      <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="2">
        <path d="M12 1v22M17 5H9.5a3.5 3.5 0 000 7H14a3.5 3.5 0 010 7H6" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
        ...
        <div className="relative mt-14 grid gap-5 md:grid-cols-2">
            ...
            <div className="relative">
              ...
              <ul className="mt-6 space-y-3 text-sm">
                {[
                  ...
                  "Perfiles 100% verificados y ordenados por reputación",
                  "Multi-sede, presupuesto y facturación automática",
                  "Sin comisiones por reserva — suscripción fija",
                ].map((b) => (
              ...
              <Button href="/clinicas" variant="outline" size="sm" className="mt-7">Ver detalles para clínicas</Button>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur md:p-10">
            ...
            <div className="relative">
              ...
              <ul className="mt-6 space-y-3 text-sm">
                {[
                  "Registro gratis, sin permanencia ni comisión",
                  "Verificación en menos de 24 h por equipo humano",
                  "Eliges turnos, ciudades y tarifa orientativa",
                  "Pagos integrados con Stripe y PayPal · factura automática",
                ].map((b) => (
                  <li key={b} className="flex items-start gap-2.5">
                    <span className="mt-0.5 inline-flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-emerald-500/90">
                      <svg className="h-2.5 w-2.5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M5 12l4.5 4.5L19 7" /></svg>
              ...
              <Button href="/profesionales" variant="outline" size="sm" className="mt-7">Ver detalles para profesionales</Button>
            </div>
          </div>
        </div>
        </div>
