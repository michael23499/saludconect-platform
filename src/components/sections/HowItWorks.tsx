...
const STEPS_PRO = [
  ...
  },
  {
    ...
    d: "Recibe solicitudes de clínicas privadas, confirma con un clic y gestiona tu agenda.",
  },
];
  ...
  return (
    <Section className="bg-white">
      ...
      <div className="mt-16 grid gap-10 lg:grid-cols-2">
        <div className="rounded-3xl border border-mist-200 bg-mist-50/50 p-8 md:p-10">
