  ...
  return (
    <section className="relative overflow-hidden">
      <div className="bg-hero">
        ...
        <div className="blob-drift-a absolute -left-20 top-0 h-72 w-72 rounded-full bg-cyan-400/20 blur-3xl" />
        <div className="blob-drift-b absolute -right-20 bottom-0 h-72 w-72 rounded-full bg-brand-500/30 blur-3xl" />
